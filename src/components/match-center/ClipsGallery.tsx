...
import { Sparkles, Play, Film, Clock } from 'lucide-react';
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
                    {group.events.map((event: any) => {
                      ...
                      const gradientClass = EVENT_COLORS[event.event_type] || 'from-purple-500/30 to-purple-900/40';
                      return (
                        <div
                          key={event.id}
                          className="group cursor-pointer rounded-xl overflow-hidden border border-purple-500/20 hover:border-purple-400/40 transition-all hover:shadow-lg hover:shadow-purple-500/10 hover:-translate-y-0.5"
