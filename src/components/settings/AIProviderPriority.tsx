...
const DEFAULT_PROVIDERS: Omit<AIProvider, 'priority' | 'enabled' | 'hasApiKey'>[] = [
  {
    id: 'ollama',
    name: 'Ollama (kakttus.ai)',
    description: 'IA local, gratuito e offline',
  ...
  },
  {
    id: 'lovable',
    name: 'Lovable AI',
    description: 'Gateway na nuvem (Gemini/GPT)',
  ...
  },
  {
    id: 'gemini',
    name: 'Google Gemini',
    description: 'API direta do Google',
  ...
  },
  {
    id: 'openai',
    name: 'OpenAI GPT',
    description: 'API direta da OpenAI',
