...
import { ArrowLeft, Download, RefreshCw, Wand2, Play, Loader2, X } from 'lucide-react';
...
import useSmartVideoRender from '@/hooks/useSmartVideoRender';
            ...
            <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="bg-card border border-border rounded-xl p-6 max-w-3xl w-full mx-4">
                ...
                <div className="flex gap-2">
                  <Button 
                    onClick={() => downloadVideo(finalVideoUrl, `${project?.title || 'video'}_smart.mp4`)}
                    className="flex-1 bg-arena-green hover:bg-arena-green/90"
                  >
